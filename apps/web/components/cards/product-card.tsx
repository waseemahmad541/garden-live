  ...
  return (
    <article className={cn("overflow-hidden rounded-gl border border-[#E3E8E2] bg-white shadow-glXs", className)}>
      <div className="relative aspect-[4/3] bg-neutral-mist">
        ...
        <Button asChild size="icon" variant="secondary" className="absolute right-3 top-3 h-9 w-9 bg-white/90" aria-label="Open wishlist in Garden Store">
          <Link href="/garden-store">
      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex items-center justify-between gap-3">
          ...
          <Button asChild size="sm" leftIcon={<ShoppingBag className="h-4 w-4" aria-hidden />}>
            <Link href="/garden-store">Add</Link>
          </Button>
        </div>
      </div>
    </article>
